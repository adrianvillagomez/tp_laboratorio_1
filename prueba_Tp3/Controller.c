...
int controller_sortEmployee(LinkedList* pArrayListEmployee)
{
	...
	if (pArrayListEmployee != NULL)
	{
		if(utn_getNumero(&opcion,"Menu de Ordenamiento\n"
								 ...
								 "\nSeleccione 4.-Ordenar lista por ID","Dato invalido\n"
								 "\nSeleccione 5.-Para salir", 1, 5, 2)==0)
		{
			switch(opcion)
			{
				case 1 :
					ll_sort(pArrayListEmployee, sort_salario,1);
					printf("\nSalarios ordenados con exito\n");
					break;
				case 2:
					ll_sort(pArrayListEmployee, sort_nombre,1);
					printf("\nNombres ordenados con exito\n");
					break;
				case 3:
					ll_sort(pArrayListEmployee, sort_horasDeTrabajo, 1);
					printf("\nHoras de trabajo ordenadas con exito\n");
					break;
				case 4:
					ll_sort(pArrayListEmployee, sort_id,1);
					printf("\nIds ordenados con exito\n");
					break;
				case 5:
					break;
			}
